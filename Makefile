...
FLAGS_CHECK = -std=f2008 -fimplicit-none -frange-check -fmax-errors=10 -pedantic -pedantic-errors -Waliasing -Wampersand -Wcharacter-truncation -Wline-truncation -Wsurprising -Wno-tabs -Wunderflow -ffpe-trap=invalid,zero,overflow -Wunused -Werror -O3 -finline-functions -DFORCE_VECTORIZATION
...
SCOTCH_DIR = 
SCOTCH_INCDIR = /usr/include/scotch
SCOTCH_LIBDIR = /usr/lib
